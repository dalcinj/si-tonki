...
def lista_produtos_categoria(request, id_categoria):
    categoria = CategoriaProduto.get_gategoria_id(id_categoria)
    lista_produtos = BancoProduto.get_prod_cat(categoria)
...
def lista_produtos_marca(request, id_marca):
    marca = MarcaProduto.get_marca_id(id_marca)
    lista_produtos = BancoProduto.get_prod_marca(marca)
...
def detalhes_produto(request, id_produto):
    produto = BancoProduto.get_prod_id(id_produto)
